...
class Review(BaseModel):
    ...
    summary: str = Field(description="A brief summary about the film")
    sentiment: Literal["pos","neg","neutral"] = Field(description="Generate sentiment of the review either positive or negative or neutral")
...
#we get NotImplementedError cause gemini still doesnt have structured_output function.