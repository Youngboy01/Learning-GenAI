...
# p1 = Person(name="Mitanshu", age=25)
# print(p1)
# ---------------------------------------------------------------------------------------------------
...
class Review(TypedDict):
    ...
    summary: Annotated[str,"A brief summary about the film"]
    sentiment: Annotated[str,"Generate sentiment of the review either positive or negative or neutral"]
